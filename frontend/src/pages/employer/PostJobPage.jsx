...
const PostJobPage = () => {
    ...
    const mutation = useMutation({
        ...
        onSuccess: ({ data }) => {
            ...
            // Invalidate the query for the employer's job list so the dashboard is up-to-date
            queryClient.invalidateQueries({ queryKey: ['myEmployerJobs'] });

            // THE FIX IS HERE: Redirect to the main dashboard instead of the applicants page
            ...
            <div className="max-w-3xl mx-auto p-8 border rounded-lg shadow-lg bg-surface">
                ...
                <FormProvider {...methods}>
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <Input name="salaryMin" label="Minimum Annual Salary (Optional)" type="number" placeholder="e.g., 800000" />
                            <Input name="salaryMax" label="Maximum Annual Salary (Optional)" type="number" placeholder="e.g., 1200000" />
                        </div>
